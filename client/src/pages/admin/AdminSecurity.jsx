                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-200 dark:border-emerald-800">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-emerald-600 dark:text-emerald-500">Your account is protected with an authenticator app</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {showDisableDialog ? (
                                    <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-800 space-y-4">
                                        ...
                                        <p className="text-sm text-red-600 dark:text-red-400">Enter your current 2FA code to disable:</p>
                                        <input
                                            type="text"
                                            value={disableCode}
                                    ...
                                    <button
                                        ...
                                        className="btn-secondary w-full text-red-500 hover:text-red-600"
                                    >
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-primary-50 dark:bg-primary-900/20 rounded-xl border border-primary-200 dark:border-primary-800">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <code className="text-sm bg-dark-100 dark:bg-dark-800 px-3 py-1 rounded font-mono">
                                            {setupData.secret}
                                        </code>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-4 p-4 bg-dark-50 dark:bg-dark-800 rounded-xl">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-dark-500">Use Google Authenticator, Authy, or any TOTP app</p>
                                    </div>
                                </div>
